...
public interface RoleRepository extends JpaRepository<RoleEntity, Long> {
    ...
    <R> List<R> findAllByPermissionsScheduleIdAndBusinessIdOrBusinessIdAndPermissionsScheduleId(Long scheduleId1,
            Long businessId1, Long businessId2, Long scheduleId2, Class<R> type);
